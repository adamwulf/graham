...
final class DotEnvTests: XCTestCase {
    ...
    override func setUpWithError() throws {
        root = FileManager.default.temporaryDirectory
            .appendingPathComponent("sergey-dotenv-tests-\(UUID().uuidString)")
    ...
    func testReturnsNilWhenNotFound() throws {
        XCTAssertNil(DotEnv.loadValue(forKey: "SERGEY_TEST_KEY_THAT_DOES_NOT_EXIST", startingIn: root))
    }
    ...
    func testResolveThrowsWithoutClientID() throws {
        XCTAssertThrowsError(
            ...
            guard case SergeyError.missingCredentials(let key) = error else {
