...
/// A page's background fill.
///
/// Setting the `solidFill` or `stretchedPictureFill` implicitly renders the
/// fill; a caller that wants no fill sets ``propertyState`` to
/// ``PropertyState/notRendered``.
