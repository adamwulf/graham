...
public protocol SergeyRow: Encodable {
...
public enum OutputFormatter {
    public static func render<Row: SergeyRow>(_ items: [Row], format: OutputFormat) throws -> String {
        switch format {
        case .id:
    ...
    static func table<Row: SergeyRow>(_ items: [Row]) -> String {
