...
/// The errors that SergeyKit can throw.
public enum SergeyError: Error, LocalizedError {
    ...
    public var errorDescription: String? {
        ...
        case .missingRefreshToken:
            return "No refresh token found. Run \"sergey auth login\", then add the printed "
